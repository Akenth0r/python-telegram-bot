...
class Bot:
    ...
    def method(self, method_name, json_data):
    ...
    def send_message(self, chat_id, text, keyboard_array=None, reply_to_message_id=None):
        ...
        if keyboard_array is not None:
            data["reply_markup"] = self.reply_keyboard(keyboard_array)
        if reply_to_message_id is not None:
            data["reply_to_message_id"] = reply_to_message_id
        self.method("sendMessage", data)  # response: Response =

    def reply_keyboard(self, keyboard_array):
